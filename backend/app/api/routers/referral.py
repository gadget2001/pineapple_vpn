...
INVITE_TEMPLATES = [
    (
        ...
        "🎁 По моему приглашению тебе доступно <b>7 дней бесплатно</b> вместо 3.\n"
        "💸 А мне начисляется <b>10% от твоих пополнений</b>, пока ты пользуешься сервисом.\n\n"
        "👇 Открывай бота и запускай MiniApp:\n"
        "{link}"
    ),
    (
        "🌍 Если ты живешь или часто бываешь за границей, попробуй <b>Pineapple VPN</b>.\n\n"
        "✅ Стабильный доступ к российским сервисам\n"
        "🎁 По приглашению — <b>7 дней trial</b> вместо 3\n"
        "💸 Пригласившему идет 10% от пополнений друга\n\n"
        "Запуск по ссылке:\n"
        "{link}"
    ),
]
