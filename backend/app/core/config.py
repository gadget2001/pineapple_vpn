...
class Settings(BaseSettings):
    ...
    vpn_android_hiddify_scheme: str = "hiddify://import/{url}#{name}"
    vpn_android_client_name: str = "Hiddify"
    vpn_android_store_url: str = "https://play.google.com/store/apps/details?id=app.hiddify.com"
