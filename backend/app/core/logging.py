...
ACTION_TITLES = {
    ...
    "vpn_cleanup_skipped_active_subscription": "Очистка VPN пропущена (есть активная подписка)",
    "vpn_cleanup_failed": "Не удалось деактивировать VPN-профиль",
    ...
    "vpn_flclash_apk_download_opened": "Открыта ссылка загрузки FlClash APK",
    "vpn_flclash_install_link_generated": "Сгенерирована FlClash-ссылка автонастройки",
    "vpn_flclash_install_opened": "Открыта FlClash-ссылка автонастройки",
    "vpn_flclash_fallback_opened": "Открыт FlClash fallback",
    ...
    "trial_activation_reminder_sent": "Отправлено напоминание об активации trial",
    "trial_activation_reminder_skipped_blocked_bot": "Напоминание trial пропущено (бот заблокирован/чат удалён)",
...
ACTION_SEVERITY = {
    ...
    "vpn_cleanup_skipped_active_subscription": "green",
    "vpn_cleanup_failed": "yellow",
    "daily_limit_reached": "red",
    "user_purged": "red",
    # Warning / requires attention
    "subscription_reminder_sent": "yellow",
    "trial_activation_reminder_sent": "yellow",
    "trial_activation_reminder_skipped_blocked_bot": "green",
    "vpn_install_fallback_opened": "yellow",
    "vpn_install_fallback_opened_ios": "yellow",
    "vpn_flclash_fallback_opened": "yellow",
