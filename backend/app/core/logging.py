...
ACTION_TITLES = {
    ...
    "vpn_install_link_generated_ios": "iOS install link generated",
    "vpn_install_link_opened_ios": "iOS install link opened",
    "vpn_install_fallback_opened_ios": "iOS install fallback opened",
