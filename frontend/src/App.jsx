...
const INTRO_SLIDES = [
  ...
  },
  {
    ...
    points: ["Банки", "Рабочие системы", "ЖКХ-сервисы"],
  },
  {
    badge: "Быстрый старт",
...
function buildInviteMessage(link) {
  ...
  return [
    "🍍 Pineapple VPN",
    "",
    "Надежный доступ к российским сервисам из-за границы: банки, Рабочие системы, ЖКХ и рабочие системы.",
    "",
...
function configInstructionByOs(os) {
  ...
  if (os === "android") {
    return [
      ...
      "Выберите приложение FlClash снизу экрана.",
      "Подтвердите в прилодении добавление профиля.",
      "Перейдите в «Панель управления» в нижнем меню.",
      "Включите ВПН кнопкой «Пуск» в правом нижнем углу и подтвердите подключение.",
              ...
              {onboardingStep === "welcome" && (
                <>
                  <p>
                    ...
                    банки, Рабочие системы, ЖКХ, рабочие и корпоративные системы.
                  </p>
