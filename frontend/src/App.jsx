...
function configInstructionByOs(os) {
  ...
  if (os === "windows") {
    return [
      "Нажмите на этой странице <Скопировать кофигурацию>",
      "Откройте nekobox.exe.",
      "В верхней панели нажмите на раздел <Сервер>",
      "Затем <Добавить профиль из буфера обмена>",
      "После чего соглашаемся с добавлением конфигурации как подписки",
      "В правой части верхней панели ставим галочку у <Режим TUN>",
      "Далее приложение запросит права администратора",
      "После чего правой кнопкой мыши нажимаем на добавленный ВПН",
      "Жмем <Запустить>/<Остановить>, чтобы включить или выключить ВПН",
    ];
  }
  if (os === "android") {
    return [
